...
const programma: { tijd: string; title: string; desc: string; topics?: string[]; presentator?: string }[] = [
  {
    ...
    desc: "Registreer je team en geniet van een welkomstdrink voor de quiz begint.",
  },
  {
    tijd: "19:30 – 20:00",
    title: "Kick-off & spelregels",
    desc: "Toelichting van het verloop van de avond en de spelregels van de quiz.",
  },
  {
    tijd: "20:00 – 21:30",
    title: "Quizronde 1 – 4",
  ...
  {
    tijd: "21:30 – 22:00",
    title: "Pauze & netwerking",
    desc: "Tijd om bij te tanken, te netwerken en strategie te smeden voor de tweede helft.",
  },
  {
    tijd: "22:00 – 23:00",
...
export default function EventBigQuiz() {
    ...
    <div className="min-h-screen bg-white text-neutral-800">
      ...
      <header className="border-b border-dashed border-neutral-400 bg-neutral-100">
        <div className="mx-auto flex max-w-[1200px] items-center justify-between px-4 py-3">
          <span className="text-xs uppercase tracking-wider text-neutral-500">Event</span>
      ...
      <div className="mx-auto max-w-[1200px] px-4 py-8">
        <div className="grid gap-8 lg:grid-cols-[1fr_320px]">
          ...
          <main className="space-y-10">
            ...
            {/* Block 02 — Title */}
            <section>
              <h1 className="text-4xl font-bold text-neutral-900">BIG Marketing Quiz</h1>
            ...
            <section className="rounded border border-neutral-300 bg-neutral-100 p-6">
              <ul className="space-y-2 italic text-neutral-700">
                <li>• Het ultieme marketingfeest van het jaar</li>
                <li>• Test je kennis tegen de scherpste marketingbreinen van het land</li>
                <li>• Netwerk met collega's uit de hele sector</li>
                <li>• Mooie prijzen voor het winnende team</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <a href="/contact" className="flex items-center gap-4 rounded border border-neutral-300 p-4 transition-colors hover:border-neutral-900 hover:bg-neutral-50">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-neutral-500">Contactpersoon events</p>
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-6 space-y-4 rounded border border-neutral-300 bg-neutral-50 p-5">
              ...
              <div className="space-y-1 text-sm">
                <div className="flex justify-between"><span>BAM-Leden</span><span>Gratis</span></div>
                <div className="flex justify-between"><span>Niet-leden</span><span>€ 99</span></div>
            ...
            <div className="mt-3 rounded border border-neutral-300 bg-white p-3 text-xs">
              <div className="flex items-center justify-between">
                ...
                <span className="text-neutral-600">+48 leden</span>
              </div>
              <div className="mt-2 flex justify-between border-t border-neutral-200 pt-2 text-neutral-700">
                <span><strong className="text-neutral-900">112</strong> ingeschreven</span>
            ...
            <div className="mt-4 flex items-center justify-end gap-2">
              ...
              <a
                href={`mailto:?subject=${encodeURIComponent("BIG Marketing Quiz")}&body=${encodeURIComponent(typeof window !== "undefined" ? window.location.href : "")}`}
