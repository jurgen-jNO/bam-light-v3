            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              ...
              <div className="shrink-0">
                <a
                  ...
                  className="inline-block px-6 py-3 border-2 border-dotted border-foreground/50 text-foreground text-xs uppercase tracking-widest font-semibold hover:bg-foreground hover:text-background transition-colors"
                >
                  Maak gratis profiel →
                </a>
              </div>
