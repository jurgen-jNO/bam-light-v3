        ...
        <div className="border-b-2 border-dashed border-foreground/30 pb-6 mb-6">
          ...
          <div className="flex flex-wrap items-end justify-between gap-4">
            ...
            <div className="border-2 border-dashed border-foreground/40 px-4 py-2.5">
              ...
              <p className="text-[10px] uppercase tracking-widest text-foreground/50 mt-1">tot 14/05/27</p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="border-2 border-dashed border-foreground/30 opacity-70 pointer-events-none">
                ...
                {vacancies.map((v, i) => {
                  ...
                  return (
                  <div key={v.id} className={`grid grid-cols-[1.4fr_1fr_auto_auto] gap-3 px-4 py-3 border-t-2 border-dashed border-foreground/20 items-center text-sm ${archived ? "opacity-50" : ""}`}>
