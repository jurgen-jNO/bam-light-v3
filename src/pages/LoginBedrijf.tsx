  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 max-w-[480px] mx-auto w-full px-6 py-12">
        ...
        <p className="text-[10px] uppercase tracking-widest text-foreground/50 mb-2">[ login — bedrijf ]</p>
        <h1 className="text-3xl font-bold text-foreground mb-8">Inloggen</h1>

        <form
          onSubmit={(e) => {
            e.preventDefault();
            navigate("/account/bedrijf");
          }}
          className="border-2 border-dashed border-foreground/40 bg-foreground/[0.02] p-6 space-y-4"
        >
          <label className="block">
            <span className="block text-[10px] uppercase tracking-widest text-foreground/50 mb-1.5">Bedrijfs e-mail</span>
