...
const artikel = {
  ...
  blocks: [
    { type: "subtitle" as const, text: "1. De terugkeer van het ambacht" },
    {
    ...
    { type: "visual" as const, caption: "Visual — campagnebeeld of moodboard (16:9)" },
    {
      type: "paragraph" as const,
    ...
    { type: "subtitle" as const, text: "2. AI als creatieve partner, niet als vervanger" },
    {
      type: "paragraph" as const,
        ...
        <div className="border-b-2 border-dashed border-foreground/30 pb-5 mb-8 flex items-end justify-between flex-wrap gap-4">
          <div>
            <p className="text-[10px] uppercase tracking-widest text-foreground/50 mb-2">
              [ wireframe — artikel detail · members only ]
            </p>
            <Link
              to="/"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-10">
          ...
          <article className="min-w-0">
            ...
            <div className="flex items-center gap-3 text-[10px] uppercase tracking-widest font-semibold text-foreground/60 mb-4">
              ...
              <span className="inline-flex items-center gap-1.5 px-2 py-1 border-2 border-dashed border-foreground/40">
            ...
            <div className="relative">
              ...
              >
                {artikel.blocks.map((b, i) => {
                  ...
                  if (b.type === "visual") {
                    return <WireBox key={i} label={b.caption} ratio="aspect-[32/9]" />;
                  }
                  return null;
                })}
              </div>
...
export default BamMagazineLocked;
