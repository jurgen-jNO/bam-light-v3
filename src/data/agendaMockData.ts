...
export const agendaMockData: AgendaItem[] = [
  ...
  },
  {
    ...
    type: "opleiding",
    subtype: "dagopleiding",
    titel: "Dagopleiding AI & Marketing Automation",
    ...
    locatie_naam: "BAM",
    adres_gemeente: "Dilbeek",
    sessies: [{ datum: "2026-08-12", starttijd: "09:30", eindtijd: "17:00" }],
  },
  {
    id: "o8",
    type: "opleiding",
    subtype: "meerdaagse",
    titel: "Meerdaagse opleiding Data-Driven Marketing",
    slug: "data-driven-marketing-2026",
    is_archived: false,
    interesse_email_actief: true,
    prijs_lid: 1450,
    prijs_niet_lid: 1850,
    early_bird_lid: 1250,
    early_bird_vervaldatum: "2026-08-01",
    locatie_naam: "BAM",
    adres_gemeente: "Dilbeek",
    sessies: [
      { datum: "2026-09-02", starttijd: "09:30", eindtijd: "13:00" },
      { datum: "2026-09-16", starttijd: "09:30", eindtijd: "13:00" },
      { datum: "2026-09-30", starttijd: "09:30", eindtijd: "13:00" },
    ],
  },
  {
    id: "o9",
    type: "opleiding",
    subtype: "dagopleiding",
    titel: "Dagopleiding Conversieoptimalisatie",
    slug: "conversieoptimalisatie-2026",
    is_archived: false,
    interesse_email_actief: true,
    prijs_lid: 450,
    prijs_niet_lid: 650,
    locatie_naam: "BAM",
    adres_gemeente: "Dilbeek",
    sessies: [{ datum: "2026-10-14", starttijd: "09:30", eindtijd: "17:00" }],
  },
  {
    id: "e1",
    type: "event",
  ...
  },
  {
    ...
    type: "event",
    subtype: "activiteit",
    titel: "BAM Year End Celebration",
    slug: "bam-year-end-2026",
    is_archived: false,
    interesse_email_actief: true,
    prijs_lid: 45,
    prijs_niet_lid: 95,
    locatie_naam: "De Munt",
    adres_gemeente: "Brussel",
    sessies: [{ datum: "2026-11-12", starttijd: "18:00", eindtijd: "23:00" }],
  },
  {
    id: "e7",
    type: "event",
    subtype: "award",
    titel: "BAM Awards 2026",
    slug: "bam-awards-2026",
    is_archived: false,
    interesse_email_actief: true,
    prijs_lid: 195,
    prijs_niet_lid: 295,
    early_bird_lid: 145,
    early_bird_vervaldatum: "2026-10-01",
    locatie_naam: "Vooruit",
    adres_gemeente: "Gent",
    sessies: [{ datum: "2026-11-18", starttijd: "19:00", eindtijd: "23:30" }],
  },
  {
    id: "e8",
    type: "event",
    subtype: "congres",
    titel: "Digital Marketing Summit",
    ...
    locatie_naam: "BluePoint",
    adres_gemeente: "Antwerpen",
    sessies: [{ datum: "2026-12-02", starttijd: "09:00", eindtijd: "17:00" }],
  },
];
