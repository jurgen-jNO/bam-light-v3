...
// Synced with src/components/MainNavigation.tsx, but pointing to /mobile/* routes.
const navItems: NavItem[] = [
  {
    label: "Academy",
    href: "/mobile/agenda",
    children: [
      { label: "Agenda", href: "/mobile/agenda" },
      { label: "Dagopleidingen", href: "/mobile/dagopleiding" },
      { label: "Meerdaagse trainingen", href: "/mobile/event" },
      { label: "Op maat (van uw bedrijf)", href: "/mobile/agenda?type=opleidingen&subtype=op-maat" },
    ],
  },
  {
    label: "Events",
    href: "/mobile/events",
    children: [
      { label: "Overzicht", href: "/mobile/agenda?type=events" },
      { label: "Activiteiten", href: "/mobile/event/big-marketing-quiz" },
      { label: "Awards", href: "/mobile/events?type=events&subtype=award" },
      { label: "Congress", href: "/mobile/events?type=events&subtype=congres" },
    ],
  },
  {
    label: "Community",
    children: [
      ...
      { label: "BAM Leden", href: "/mobile/leden" },
      { label: "Onze Sponsors", href: "/mobile/sponsors" },
      { label: "Affiliates", href: "/mobile/affiliations" },
    ],
  },
  {
    label: "Expert Views",
    href: "/mobile/artikels",
    children: [
      { label: "Artikels", href: "/mobile/artikel" },
      { label: "BAM magazine", href: "/mobile/bam-magazine/locked" },
...
const sitemapLinks = [
  ...
  { label: "Onze leden", href: "/mobile/leden" },
        ...
        <nav className="bg-nav sticky top-0 z-50">
          <div className="flex items-center justify-between px-4 h-16">
            ...
            <div className="flex items-center gap-1">
              ...
              <a href="/mobile/login" className="p-2 text-nav-fg" aria-label="Login">
              ...
              <div className="flex flex-wrap gap-4">
                {legalLinks.map((l) => (
                  <a
                    key={l.label}
                    href={l.href}
                    className="text-xs text-footer-muted hover:text-footer-fg transition-colors"
                  >
                    {l.label}
                  </a>
                ))}
